...
{
  //this function is redundant and bad, redirecting to the fixed remove_item_from_inventory()
  return remove_item_from_inventory(player,item_index); //my code
...
void * play_game(void *arg) 
{
    ...
    //my code
    struct _inventory_item *next = NULL;
    while(player->bag != NULL) {
