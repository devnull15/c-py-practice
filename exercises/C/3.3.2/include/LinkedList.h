#ifndef JQR_332_LINKED_LIST_H
#define JQR_332_LINKED_LIST_H

#include <stdbool.h>
#include <stdio.h>
#include <stdlib.h>
#include <assert.h>
#include "../Common/wrap_assert/wrap_assert.h"
 ...
 *        pointer to the data value in a node as the first parameter. It takes an
 *        optional second parameter. The second parameter is provided to as an option
 *        to the library user depending on what they write the action function to do.
 * 
 *        The action function is used in the linked_list_for_each() function to allow a
 *        function with this prototype to be called on every node in the linked list.
 * 
 *        i.e. Common uses for this might be a function that prints each value in the list.
 * 
 */
